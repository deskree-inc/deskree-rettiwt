...
<template>
  <main
    class="w-screen h-screen bg-background text-white max-h-screen overflow-scroll pt-10"
  >
    <div class="grid grid-cols-3 mobile:grid-cols-1 mobile:px-3">
      <!-- Left column -->
      <div
        class="col-span-1 h-screen mobile:hidden w-full flex justify-end pt-2"
      >
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                <h4 class="font-normal font-sans text-sm text-text">
                  Wellington
                </h4>
            ...
            <div class="flex flex-col items-start gap-3">
              <nav class="flex items-center gap-4">
                ...
                <span
                  class="font-sans font-semibold text-xs pt-0.5 text-primary"
                  >Home</span
                >
              </nav>
      ...
      <!-- Right column -->
      <div class="col-span-1 h-screen mobile:hidden"></div>
    </div>
  </main>
</template>
